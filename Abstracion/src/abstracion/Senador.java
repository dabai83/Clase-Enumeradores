...
public class Senador extends Legislador{
    ...
    public Senador(String provinciaQueRepresenta, String nombre, String apellido) {
    ...
    public String getCamaraEnQueTrabaja() {
        return ("Trabajo en la cama de Senadores") ; //To change body of generated methods, choose Tools | Templates.
    }
